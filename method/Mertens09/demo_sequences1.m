...
for i = 1 : 360
    ...
    if (want_to_save_result)
        imwrite(img_result, ['E:\paper\dataset1_result\Mertens09\MEF_dataset1\',image_name,'_Mertens_CGF09.tif']);
    ...
    fI1 = imread(['E:\paper\dataset1_result\Mertens09\MEF_dataset1\',image_name,'_Mertens_CGF09.tif']);
...
for i = 1 : 229
    ...
    want_to_save_result = 1;
    if (want_to_save_result)
        imwrite(img_result, ['E:\paper\dataset1_result\Mertens09\MEF_dataset2\',image_name,'_Mertens_CGF09.tif']);
        %imwrite(img_result, ['G:/dataset/HDR/MEFDatabase/result/',image_name,'/result01.png']);
    end
    ...
    fI1 = imread(['E:\paper\dataset1_result\Mertens09\MEF_dataset2\',image_name,'_Mertens_CGF09.tif']);
    fI1 = double(rgb2gray(fI1));
