...
for k = 3 : length_file
    ...
    if (want_to_save_result)
        imwrite(img_result, ['E:\paper\dataset6_result\shutao_Li13\dataset6_result\',files(k).name,'_shutao_Li_TIP13.tif']);
    end
%% evalutate using MEF-SSIM
    ...
    fI1 = imread(['E:\paper\dataset6_result\shutao_Li13\dataset6_result\',files(k).name,'_shutao_Li_TIP13.tif']);
