...
for i = 1 : 360
    ...
    if (want_to_save_result)
        imwrite(img_result, ['E:\paper\dataset1_result\shutao_Li13\Dataset_Part1\',image_name,'_shutao_Li_TIP13.tif']);
...
%% evalutate using MEF-SSIM
    ...
    fI1 = imread(['E:\paper\dataset1_result\shutao_Li13\Dataset_Part1\',image_name,'_shutao_Li_TIP13.tif']);
...
for i = 1 : 229
    ...
    want_to_save_result = 1;
    if (want_to_save_result)
        imwrite(img_result, ['E:\paper\dataset1_result\shutao_Li13\Dataset_Part2\',image_name,'_shutao_Li_TIP13.tif']);
        %imwrite(img_result, ['G:/dataset/HDR/MEFDatabase/result/',image_name,'/result01.png']);
    end
%% evalutate using MEF-SSIM
    ...
    fI1 = imread(['E:\paper\dataset1_result\shutao_Li13\Dataset_Part2\',image_name,'_shutao_Li_TIP13.tif']);
    fI1 = double(rgb2gray(fI1));
