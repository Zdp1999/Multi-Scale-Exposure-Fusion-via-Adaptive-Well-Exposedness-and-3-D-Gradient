...
for k = 3 : length_file
    ...
    if (want_to_save_result)
        imwrite(img_result, ['E:\paper\dataset6_result\Kou17\dataset6_result\',files(k).name,'_kou_ICME17.tif']);
    end
%% evalutate using MEF-SSIM
    ...
    fI1 = imread(['E:\paper\dataset6_result\Kou17\dataset6_result\',files(k).name,'_kou_ICME17.tif']);
